...
import FormDeterminacionMod from './Components/Determinacion/ConsultaDeterminacion';
...
ReactDOM.render(
    ...
    <Router>
        ...
        <AuthenticatedRoute exact path="/determinaciones/modificar/:id" component={FormDeterminacionMod}/>
        </Switch>
    </Router>
