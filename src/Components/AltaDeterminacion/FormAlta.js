    ...
    return (    
      <div className='Formularios'>
        <Container className='btnHeader'>
          <Button className='boton' as= {Link} to='/' exact='true' floated='left' icon labelPosition='left' primary size='small'>
        ...
        <Form onSubmit={this.fetchDeterminacion}>
          ...
          <Form.Field label='Metodologia' control='input' placeholder='Metodologia' value={this.state.metodologia} onChange={this.cambioMetodologia}/>

          <Form.Field required label='Descripcion' control='input'
          placeholder='Descripción' value={this.state.descripcion} onChange={this.cambioDescripcion} className= {this.state.errorDescripcion ? null : 'error' } />

          <Form.Field label='Valor' control='input' placeholder='Valor' value={this.state.valor} onChange={this.cambioValor}/>

          <Form.Field label='ProtocoloId' control='input' placeholder='ProtocoloId' value={this.state.protocoloId} onChange={this.cambioProtocoloId}/>      
