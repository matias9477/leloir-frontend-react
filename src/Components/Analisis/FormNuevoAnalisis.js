    ...
    return (
      <div className='union'>
        ...
        <Form className="formAnalsis">
          ...
          {/* //TODO: q el boton no aparezca hasta q se llene el paciente y las det */}
...
export default  connect(mapStateToProps, {getPatientsAction})(FormNuevoAnalisis)